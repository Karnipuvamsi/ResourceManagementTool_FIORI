sap.ui.define([
    ...
    const ProjectsNearingCompletionReportFilterBarDelegate = Object.assign({}, FilterBarDelegate);

    ProjectsNearingCompletionReportFilterBarDelegate.fetchProperties = async function (oFilterBar) {
        const oModel = oFilterBar.getModel("default") || oFilterBar.getModel();
        const sEntitySet = "ProjectsNearingCompletionReport";
    ...
    ProjectsNearingCompletionReportFilterBarDelegate.addItem = function (oFilterBar, sPropertyName) {
        const sId = oFilterBar.getId() + "--filter--" + sPropertyName;
        const sFragmentName = "ProjectsNearingCompletionReport";
    ...
    ProjectsNearingCompletionReportFilterBarDelegate.removeItem = async function (oFilterBar, oFilterField) {
        oFilterField.destroy();
        return true;
    };

    return ProjectsNearingCompletionReportFilterBarDelegate;
});
